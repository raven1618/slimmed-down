  ...
  public: {
    Tables: {
      ...
      patientcase: {
        ...
        Relationships: [
          {
            foreignKeyName: "patientcase_destination_facility_fkey"
            columns: ["destination_facility"]
            isOneToOne: false
            referencedRelation: "facility"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "patientcase_origin_facility_fkey"
            columns: ["origin_facility"]
            isOneToOne: false
            referencedRelation: "facility"
            referencedColumns: ["id"]
          },
      ...
      transport: {
        ...
        Relationships: [
          {
            foreignKeyName: "transport_patientcase_id_fkey"
            columns: ["patientcase_id"]
            isOneToOne: false
            referencedRelation: "patientcase"
            referencedColumns: ["id"]
          },
      ...
      treatment_auth: {
        ...
        Relationships: [
          {
            foreignKeyName: "treatment_auth_patientcase_id_fkey"
            columns: ["patientcase_id"]
            isOneToOne: false
            referencedRelation: "patientcase"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_avg_response_time_last_24h: {
        Args: Record<PropertyKey, never>
        Returns: number
      }
      get_open_emergency_count: {
        Args: Record<PropertyKey, never>
        Returns: number
      }
      get_pending_auth_count: {
        Args: Record<PropertyKey, never>
        Returns: number
      }
      get_proj4_from_srid: {
